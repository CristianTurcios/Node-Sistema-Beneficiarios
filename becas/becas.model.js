...
function model(sequelize) {
    const attributes = {
        ...
        educationalLevelMother: { type: DataTypes.STRING, allowNull: true },
        educationalLevelFather: { type: DataTypes.STRING, allowNull: true },
        fathersAddress: { type: DataTypes.STRING, allowNull: true },
        motherWork: { type: DataTypes.STRING, allowNull: true },
        fatherWork: { type: DataTypes.STRING, allowNull: true },
